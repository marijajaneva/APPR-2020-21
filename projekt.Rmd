...
```{r graf_visoko_breme, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}

graf_nizko_breme + xlab("Leto") + ylab("Število gospodinjstev") + ggtitle ("Število gospodinjstev, katerim stroški stanovanja predstavljajo visoko breme")
