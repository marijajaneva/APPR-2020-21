...
```{r graf_nizko_breme, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}

graf_nizko_breme + xlab("Leto") + ylab("Število gospodinjstev") + ggtitle ("Število gospodinjstev, katerim stroški stanovanja predstavljajo nizko breme")

```
```{r graf_srednje_breme, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}

graf_srednje_breme + xlab("Leto") + ylab("Število gospodinjstev") + ggtitle ("Število gospodinjstev, katerim stroški stanovanja predstavljajo srednje breme")

```

```{r graf_veliko_breme, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}

graf_veliko_breme + xlab("Leto") + ylab("Število gospodinjstev") + ggtitle ("Število gospodinjstev, katerim stroški stanovanja predstavljajo veliko breme")
